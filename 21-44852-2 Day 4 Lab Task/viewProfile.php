...
<body>
    <table border="1" align="center" width="100%">
        <tr>
            <td colspan="3"><h1 align="left" width=""></h1><img scr="xcomapny.png"><p align="right">Logged in as |<a href="Asheke">Asheke</a>|<a href="Logout">Logout</a></p></td>
        <tr rowspan="10">
            <td>
                <h3>Account</h3>
                <hr>
            ...
            <fieldset>
                ...
                Gender:<input type="text" name="" value="" /> <br>
